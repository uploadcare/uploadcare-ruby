    ...
    describe '.upload' do
      context 'with URL source' do
        ...
        it 'detects URL and uses upload_from_url' do
          result = described_class.upload(object: url, store: true)
      ...
      context 'with file path (small file)' do
        ...
        it 'detects small file and uses upload_file' do
          ...
          result = described_class.upload(object: file, store: true)
          file.close
      ...
      context 'with invalid source' do
        it 'raises ArgumentError for nil' do
          expect { described_class.upload(object: nil) }.to raise_error(ArgumentError, /Expected input to be/)
        end

        it 'raises ArgumentError for unsupported type' do
          expect { described_class.upload(object: 12_345) }.to raise_error(ArgumentError, /Expected input to be/)
        end
        ...
        it 'raises ArgumentError for non-existent file path' do
          ...
          expect do
            described_class.upload(object: 'nonexistent.jpg')
      ...
      context 'with array of files' do
        ...
        it 'uploads multiple files' do
          results = described_class.upload(object: files, store: true)

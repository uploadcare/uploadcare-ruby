...
module Uploadcare
  class DocumentConverter < BaseResource
    ...
    # v4.4.3 compatibility: convert method alias
    def self.convert(document_params, options = {}, config = Uploadcare.configuration)
      convert_document(document_params, options, config)
    end

...
module Uploadcare
  module Resources
    class Group < BaseResource
      ...
      attr_accessor :id, :datetime_removed, :datetime_stored, :datetime_uploaded, :is_image, :is_ready, :mime_type,
                    :original_file_url, :cdn_url, :original_filename, :size, :url, :uuid, :variations,

...
module Uploadcare
  class File < BaseResource
    ...
    def convert_document(params: {}, options: {}, request_options: {})
      convert_file(params, DocumentConverter, options, request_options: request_options)
    end
    ...
    def convert_video(params: {}, options: {}, request_options: {})
      convert_file(params, VideoConverter, options, request_options: request_options)
    end

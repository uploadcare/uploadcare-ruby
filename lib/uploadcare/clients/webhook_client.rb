...
module Uploadcare
  class WebhookClient < RestClient
    ...
    def create_webhook(options = {})
      # v4.4.3 compatible: accepts options hash
      payload = {
      ...
      # Add signing_secret if provided (compact removes nil values like v4.4.3)
    ...
    def update_webhook(id, options = {})
      # v4.4.3 compatible: accepts options hash like the original client
      put("/webhooks/#{id}/", options)
    end
